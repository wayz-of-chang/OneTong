...
class ChatScreen extends React.Component {
  ...
  _switchLanguage() {
	...
	this.setState({ input: '' })
	//this._setLocalizedLanguage(this.state.selectedLanguage == 1 ? this.state.language1 : this.state.language2)
  }
  ...
  _setLocalizedLanguage(locale) {
	...
	strings.setLanguage(locale_map[locale])
  }
}
...
const strings = new LocalizationStrings({
  ...
  zh_Hans: {
	...
	deletion_message: '你确定要删除 ',
	deletion_error: '无法删除对话',
	no: '不',
	yes: '是',
	info: '这只是一个基本的对话翻译应用程序，可以帮助人们进行两种语言之间的对话。 Written by David Chang (2017).',
	send: "发送",
	new_conversation: '加入新对话',
	name: "名称",
	language1: "你的语言",
	language2: "翻译语言",
	add: "加入",
  ...
  zh_Hant: {
	...
	deletion_message: '你確定要刪除 ',
	deletion_error: '無法刪除對話',
	no: '不',
	yes: '是',
	info: '這只是一個基本的對話翻譯應用程序，可以幫助人們進行兩種語言之間的對話。  Written by David Chang (2017).',
	send: "發送",
	new_conversation: '加入新對話',
	name: "名稱",
	language1: "你的語言",
	language2: "翻譯語言",
	add: "加入",
